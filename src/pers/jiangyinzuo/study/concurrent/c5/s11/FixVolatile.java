 ...
 * @author jiang
 */
public class FixVolatile {
    public static void main(String[] args) throws InterruptedException {
        ArrayBlockingQueue<Integer> queue = new ArrayBlockingQueue<>(10);
        FixVolatile fixVolatile = new FixVolatile();
        Producer producer = fixVolatile.new Producer(queue);
        Thread producerThread = new Thread(producer);
        producerThread.start();
        Thread.sleep(1000);
        Consumer consumer = fixVolatile.new Consumer(queue);
